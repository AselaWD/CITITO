...
namespace CITITO
{
    public partial class frm_SubDashboardViewAllX3Performance : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardViewAllX3Performance _instance;
        public static frm_SubDashboardViewAllX3Performance GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardViewAllX3Performance(mMUID, mPIC);
        ...
        public frm_SubDashboardViewAllX3Performance(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardViewAllX3Performance_Load(object sender, EventArgs e)
        {
