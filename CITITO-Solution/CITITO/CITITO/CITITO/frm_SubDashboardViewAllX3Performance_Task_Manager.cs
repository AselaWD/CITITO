...
namespace CITITO
{
    public partial class frm_SubDashboardViewAllX3Performance_Task_Manager : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardViewAllX3Performance_Task_Manager _instance;
        public static frm_SubDashboardViewAllX3Performance_Task_Manager GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardViewAllX3Performance_Task_Manager(mMUID, mPIC);
        ...
        public frm_SubDashboardViewAllX3Performance_Task_Manager(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardViewAllX3Performance_Task_Manager_Load(object sender, EventArgs e)
        {
        ...
        private void btnBackToTask_Click(object sender, EventArgs e)
        {
            ...
            frm_SubDashboardX3ByTask_Manager myForm = frm_SubDashboardX3ByTask_Manager.GetInstance(uMUID, uPIC);
