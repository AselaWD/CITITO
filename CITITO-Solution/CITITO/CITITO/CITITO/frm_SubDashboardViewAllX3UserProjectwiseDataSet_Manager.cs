...
namespace CITITO
{
    public partial class frm_SubDashboardViewAllX3UserProjectwiseDataSet_Manager : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardViewAllX3UserProjectwiseDataSet_Manager _instance;
        public static frm_SubDashboardViewAllX3UserProjectwiseDataSet_Manager GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardViewAllX3UserProjectwiseDataSet_Manager(mMUID, mPIC);
        ...
        public frm_SubDashboardViewAllX3UserProjectwiseDataSet_Manager(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardViewAllX3UserProjectwiseDataSet_Manager_Load(object sender, EventArgs e)
        {
        ...
        private void btnBackToTask_Click(object sender, EventArgs e)
        {
            ...
            frm_SubDashboardX3UserProjectWise_Manager myForm = frm_SubDashboardX3UserProjectWise_Manager.GetInstance(uMUID, uPIC);
