...
namespace CITITO
{
    public partial class frm_SubDashboardViewAllX3Performance_Project_Manager : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardViewAllX3Performance_Project_Manager _instance;
        public static frm_SubDashboardViewAllX3Performance_Project_Manager GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardViewAllX3Performance_Project_Manager(mMUID, mPIC);
        ...
        public frm_SubDashboardViewAllX3Performance_Project_Manager(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardViewAllX3Performance_Project_Manager_Load(object sender, EventArgs e)
        {
