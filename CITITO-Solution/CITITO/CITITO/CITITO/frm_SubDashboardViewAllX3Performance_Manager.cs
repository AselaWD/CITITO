...
namespace CITITO
{
    public partial class frm_SubDashboardViewAllX3Performance_Manager : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardViewAllX3Performance_Manager _instance;
        public static frm_SubDashboardViewAllX3Performance_Manager GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardViewAllX3Performance_Manager(mMUID, mPIC);
        ...
        public frm_SubDashboardViewAllX3Performance_Manager(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardViewAllX3Performance_Manager_Load(object sender, EventArgs e)
        {
