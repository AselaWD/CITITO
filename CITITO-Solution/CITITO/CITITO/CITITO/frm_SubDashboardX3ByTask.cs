...
namespace CITITO
{
    public partial class frm_SubDashboardX3ByTask : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardX3ByTask _instance;
        public static frm_SubDashboardX3ByTask GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardX3ByTask(mMUID, mPIC);
        ...
        public frm_SubDashboardX3ByTask(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardX3ByTask_Load(object sender, EventArgs e)
        {
            //ClearFields();
            ...
            //Dropdown
            cmbTask.DataSource = mTaskDetailMng.GetAllTaskCodeDetailsByPIC(uPIC);
            cmbTask.SelectedIndex = -1;

            //DataGridView
            dataGridViewTaskX3Summary.DataSource = mTaskRecordDetailMng.DboardPerformanceX3Task_Ranked(uPIC, uFrom, uTo);
        ...
        private void cmbTask_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(uTask))
            {
                ...
                //DataGridView
                dataGridViewTaskX3Summary.DataSource = mTaskRecordDetailMng.DboardPerformanceX3Task_Ranked_FilterByTask(uPIC, uFrom, uTo, uTask);
        ...
        private void btnViewAll_Click(object sender, EventArgs e)
        {
            ...
            frm_SubDashboardViewAllX3Performance_Task myForm = frm_SubDashboardViewAllX3Performance_Task.GetInstance(uPIC, uMUID);
