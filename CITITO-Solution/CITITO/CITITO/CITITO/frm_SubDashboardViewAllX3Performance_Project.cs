...
namespace CITITO
{
    public partial class frm_SubDashboardViewAllX3Performance_Project : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardViewAllX3Performance_Project _instance;
        public static frm_SubDashboardViewAllX3Performance_Project GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardViewAllX3Performance_Project(mMUID, mPIC);
        ...
        public frm_SubDashboardViewAllX3Performance_Project(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardViewAllX3Performance_Project_Load(object sender, EventArgs e)
        {
