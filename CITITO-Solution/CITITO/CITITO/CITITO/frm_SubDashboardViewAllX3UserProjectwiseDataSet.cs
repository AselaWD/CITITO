...
namespace CITITO
{
    public partial class frm_SubDashboardViewAllX3UserProjectwiseDataSet : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardViewAllX3UserProjectwiseDataSet _instance;
        public static frm_SubDashboardViewAllX3UserProjectwiseDataSet GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardViewAllX3UserProjectwiseDataSet(mMUID, mPIC);
        ...
        public frm_SubDashboardViewAllX3UserProjectwiseDataSet(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardViewAllX3UserProjectwiseDataSet_Load(object sender, EventArgs e)
        {
            ...
            //DataGridView
            dataGridViewX3PerformanceDataSet.DataSource = mTaskRecordDetailMng.DboardPerformanceX3UserAllDataSet_ByPIC(uPIC, uFrom, uTo);
        ...
        private void cmbProject_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(uProject))
            {
                ...
                //DataGridView
                dataGridViewX3PerformanceDataSet.DataSource = mTaskRecordDetailMng.DboardPerformanceX3UserAllDataSet_ByPICAndProject(uPIC, uFrom, uTo, uProject);
        ...
        private void cmbUID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(uUID))
            {
                ...
                //DataGridView
                dataGridViewX3PerformanceDataSet.DataSource = mTaskRecordDetailMng.DboardPerformanceX3UserAllDataSet_ByPICAndUser(uPIC, uFrom, uTo, uUID);
        ...
        private void cmbItemCode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(uItemCode))
            {
                ...
                //DataGridView
                dataGridViewX3PerformanceDataSet.DataSource = mTaskRecordDetailMng.DboardPerformanceX3UserAllDataSet_ByPICAndItemCode(uPIC, uFrom, uTo, uItemCode);
        ...
        private void cmbTaskCode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(uTaskCode))
            {
                ...
                //DataGridView
                dataGridViewX3PerformanceDataSet.DataSource = mTaskRecordDetailMng.DboardPerformanceX3UserAllDataSet_ByPICAndTaskCode(uPIC, uFrom, uTo, uTaskCode);
