...
namespace CITITO
{
    public partial class frm_SubDashboardX3Performance : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardX3Performance _instance;
        public static frm_SubDashboardX3Performance GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardX3Performance(mMUID, mPIC);
        ...
        public frm_SubDashboardX3Performance(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardX3Performance_Load(object sender, EventArgs e)
        {
            ClearFields();
            ...
            //DataGridView
            dataGridViewX3UserWise.DataSource = mTaskRecordDetailMng.DboardPerformanceX3ByUser(uPIC, uFrom, uTo);
        ...
        //        //DataGridView
        //        dataGridViewX3UserWise.DataSource = mTaskRecordDetailMng.DboardPerformanceX3ByUser_FilterByProject(uPIC, uFrom, uTo, uProject);

        //        //dataGridViewX3ProjectWise.DataSource = mTaskRecordDetailMng.DboardPerformanceX3Project_User_FilterByProject(uPIC, uFrom, uTo, uProject);
        //        //dataGridViewX3TeamWise.DataSource = mTaskRecordDetailMng.DboardPerformanceX3Team_User_FilterByProject(uPIC, uFrom, uTo, uProject);
        //        //dataGridViewX3TaskWise.DataSource = mTaskRecordDetailMng.DboardPerformanceX3Task_User_FilterByProject(uPIC, uFrom, uTo, uProject);
        ...
        //        //DataGridView
        //        dataGridViewX3UserWise.DataSource = mTaskRecordDetailMng.DboardPerformanceX3ByUser_FilterByManager(uPIC, uFrom, uTo, uMID);

        //        //dataGridViewX3ProjectWise.DataSource = mTaskRecordDetailMng.DboardPerformanceX3Project_User_FilterByManager(uPIC, uFrom, uTo, uMID);
        //        //dataGridViewX3TeamWise.DataSource = mTaskRecordDetailMng.DboardPerformanceX3Team_User_FilterByManager(uPIC, uFrom, uTo, uMID);
        //        //dataGridViewX3TaskWise.DataSource = mTaskRecordDetailMng.DboardPerformanceX3Task_User_FilterByManager(uPIC, uFrom, uTo, uMID);
        ...
        private void cmbUID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(uUID))
            {
                ...
                //DataGridView
                dataGridViewX3UserWise.DataSource = mTaskRecordDetailMng.DboardPerformanceX3ByUser_FilterByUser(uPIC, uFrom, uTo, uUID);
        ...
        private void btnViewAll_Click(object sender, EventArgs e)
        {
            ...
            frm_SubDashboardViewAllX3Performance myForm = frm_SubDashboardViewAllX3Performance.GetInstance(uPIC, uMUID);
