...
namespace CITITO
{
    public partial class frm_SubDashboardX3ByTeam : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardX3ByTeam _instance;
        public static frm_SubDashboardX3ByTeam GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardX3ByTeam(mMUID, mPIC);

            }
            return _instance;

        }
        public frm_SubDashboardX3ByTeam(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardX3ByTeam_Load(object sender, EventArgs e)
        {
            //ClearFields();
            ...
            //DataGridView
            dataGridViewX3Summary.DataSource = mTaskRecordDetailMng.DboardPerformanceX3Team_Ranked(uPIC, uFrom, uTo);
        ...
        private void btnViewAll_Click(object sender, EventArgs e)
        {
            ...
            frm_SubDashboardViewAllX3Performance_Team myForm = frm_SubDashboardViewAllX3Performance_Team.GetInstance(uPIC, uMUID);
