...
namespace CITITO
{
    public partial class frm_SubDashboardWastage_Manager : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardWastage_Manager _instance;
        public static frm_SubDashboardWastage_Manager GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardWastage_Manager(mMUID, mPIC);
        ...
        public frm_SubDashboardWastage_Manager(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardWastage_Manager_Load(object sender, EventArgs e)
        {
            //ClearFields();
        ...
        private void cmbUID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(uUID))
            {
                ...
                //DataGridView
                dataGridViewUserWastageSummary.DataSource = mTaskRecordDetailMng.DboradUserWastageByPIC_FilterByUserAndManager(uPIC, uFrom, uTo, uUID, uMUID);
                ...
                try
                {
                    ...
                    if (!System.IO.File.Exists(fileName))
                    {
                        using (System.IO.FileStream fs = System.IO.File.Create(fileName))
                        {
                            ...
                            {
                                var ws = wb.Worksheets.Add(dt, "CITITO_" + lblUIDToFill.Text + "_IDLE & Wastage");
        ...
        private void btnViewAll_Click(object sender, EventArgs e)
        {
            ...
            frm_SubDashboardAllUserIDLEWastage_Manager myForm = frm_SubDashboardAllUserIDLEWastage_Manager.GetInstance(uMUID, uPIC);
