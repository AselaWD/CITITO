...
namespace CITITO
{
    public partial class frm_SubDashboardViewAllX3Performance_Task : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardViewAllX3Performance_Task _instance;
        public static frm_SubDashboardViewAllX3Performance_Task GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardViewAllX3Performance_Task(mMUID, mPIC);

            }
            return _instance;

        }
        public frm_SubDashboardViewAllX3Performance_Task(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardViewAllX3Performance_Task_Load(object sender, EventArgs e)
        {
