...
namespace CITITO
{
    public partial class frm_SubDashboardTeamDetails : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardTeamDetails _instance;
        public static frm_SubDashboardTeamDetails GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardTeamDetails(mMUID, mPIC);
        ...
        public frm_SubDashboardTeamDetails(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardTeamDetails_Load(object sender, EventArgs e)
        {
            ...
            //DataGridView
            dataGridViewTeamDetails.DataSource = mTaskRecordDetailMng.DboardActiveTeamDetailByPIC(uPIC);
            dataGridViewCurrentUtilization.DataSource = mTaskRecordDetailMng.DboardCurrentTeamUtilizationByPIC(uPIC);
            dataGridViewUtilizationDetailbyUID.DataSource = mTaskRecordDetailMng.DboardCurrentUtilizationDetailUIDByPIC(uPIC);
        ...
        private void cmbProject_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(uProject))
            {
                ...
                //DataGridView
                dataGridViewTeamDetails.DataSource = mTaskRecordDetailMng.DboardActiveTeamDetailByPIC_FilterByProject(uPIC, uProject);
                dataGridViewCurrentUtilization.DataSource = mTaskRecordDetailMng.DboardCurrentTeamUtilizationByPIC_FilterByProject(uPIC, uProject);
                dataGridViewUtilizationDetailbyUID.DataSource = mTaskRecordDetailMng.DboardCurrentUtilizationDetailUIDByPIC_FilterByProjct(uPIC, uProject);
        ...
        private void cmbUID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(uUID))
            {
                ...
                dataGridViewCurrentUtilization.DataSource = mTaskRecordDetailMng.DboardCurrentTeamUtilizationByPIC_FilterByUser(uPIC, uUID);
                dataGridViewUtilizationDetailbyUID.DataSource = mTaskRecordDetailMng.DboardCurrentUtilizationDetailUIDByPIC_FilterByUser(uPIC, uUID);
