...
namespace CITITO
{
    public partial class frm_SubDashboardX3ByProject : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardX3ByProject _instance;
        public static frm_SubDashboardX3ByProject GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardX3ByProject(mMUID, mPIC);
        ...
        public frm_SubDashboardX3ByProject(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardX3ByProject_Load(object sender, EventArgs e)
        {
            //ClearFields();
            ...
            //DataGridView
            dataGridViewProjectX3Summary.DataSource = mTaskRecordDetailMng.DboardPerformanceX3Project_Ranked(uPIC, uFrom, uTo);
        ...
        private void cmbProject_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(uProject))
            {
                ...
                //DataGridView
                dataGridViewProjectX3Summary.DataSource = mTaskRecordDetailMng.DboardPerformanceX3Project_Ranked_FilterByProject(uPIC, uFrom, uTo, uProject);
        ...
        private void btnViewAll_Click(object sender, EventArgs e)
        {
            ...
            frm_SubDashboardViewAllX3Performance_Project myForm = frm_SubDashboardViewAllX3Performance_Project.GetInstance(uPIC, uMUID);
