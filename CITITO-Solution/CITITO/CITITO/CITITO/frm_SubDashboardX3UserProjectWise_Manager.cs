...
namespace CITITO
{
    public partial class frm_SubDashboardX3UserProjectWise_Manager : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardX3UserProjectWise_Manager _instance;
        public static frm_SubDashboardX3UserProjectWise_Manager GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardX3UserProjectWise_Manager(mMUID, mPIC);

            }
            return _instance;

        }
        public frm_SubDashboardX3UserProjectWise_Manager(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardX3UserProjectWise_Manager_Load(object sender, EventArgs e)
        {
            ClearFields();
            ...
            //DataGridView
            dataGridViewX3UserWise.DataSource = mTaskRecordDetailMng.DboardPerformanceX3ByUserProjectWiseAndManager(uPIC, uFrom, uTo, uMUID);
        ...
        private void cmbUID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(uUID))
            {
                ...
                //DataGridView
                dataGridViewX3UserWise.DataSource = mTaskRecordDetailMng.DboardPerformanceX3ByUserProjectWiseAndManager_FilterByUser(uPIC, uFrom, uTo, uUID, uMUID);
        ...
        private void btnViewAll_Click(object sender, EventArgs e)
        {
            ...
            frm_SubDashboardViewAllX3UserProjectwiseDataSet_Manager myForm = frm_SubDashboardViewAllX3UserProjectwiseDataSet_Manager.GetInstance(uMUID, uPIC);
