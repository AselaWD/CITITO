...
namespace CITITO
{
    public partial class frm_SubDashboardAllUserIDLEWastage_Manager : MetroForm
    {
        SqlConnection conn;

        //Start Pass insatance when form is already opend or not
        private static frm_SubDashboardAllUserIDLEWastage_Manager _instance;
        public static frm_SubDashboardAllUserIDLEWastage_Manager GetInstance(string uMUID, string uPIC)
        {
            ...
            if (_instance == null || _instance.IsDisposed)
            {
                ...
                _instance = new frm_SubDashboardAllUserIDLEWastage_Manager(mMUID, mPIC);
        ...
        public frm_SubDashboardAllUserIDLEWastage_Manager(string uMUID, string uPIC)
        {
            InitializeComponent();
        ...
        private void frm_SubDashboardAllUserIDLEWastage_Manager_Load(object sender, EventArgs e)
        {
        ...
        private void btnBackToTask_Click(object sender, EventArgs e)
        {
            ...
            frm_SubDashboardWastage_Manager myForm = frm_SubDashboardWastage_Manager.GetInstance(uMUID, uPIC);
        ...
        private void cmbUID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(uUID))
            {
                ...
                //DataGridView
                dataGridViewUserIDLEAndWastageDataSet.DataSource = mTaskRecordDetailMng.DboardUserIDLEAndWastageAllDataSet_ByPIC_FilterByUserAndManager(uPIC, uFrom, uTo, uUID, uMUID);
                ...
                try
                {
                    ...
                    if (!System.IO.File.Exists(fileName))
                    {
                        using (System.IO.FileStream fs = System.IO.File.Create(fileName))
                        {
                            ...
                            {
                                var ws = wb.Worksheets.Add(dt, "CITITO_" + lblUIDToFill.Text + "_IDLE+Wastage DataSet");
