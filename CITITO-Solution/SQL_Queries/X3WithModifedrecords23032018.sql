...
DECLARE @TempModifiedTaskDetails_@mPIC TABLE(
TRM_ID varchar(100),
MODIFIED_OUTPUT float,
TRM_UID varchar(50), 
TRM_MID varchar(50),
TRM_PIC varchar(50),
MODIFIED_HOURS float 
); 
...
INSERT INTO @TempModifiedTaskDetails_@mPIC
SELECT h.TR_ID
...
INSERT INTO @TemptaskDetails_@mPIC 
	...
	, modified.MODIFIED_HOURS, cur.TR_Status, cur.TR_Apporval,cur.TR_MID,cur.TR_PIC,cur.TR_Shipment,cur.TR_File,cur.[ACTUAL_OUTPUT],
	...
	,ISNULL(modified.MODIFIED_OUTPUT,0),cur.[QUOTA], (0) AS ACTUAL_QOUTA,cur.TR_UOM,cur.PCP_ID,cur.Task_ID,cur.PC_ProcessCode,cur.PCP_Project
	FROM @TemptblDifference_@mPIC cur
	LEFT OUTER JOIN @TempModifiedTaskDetails_@mPIC modified ON modified.TRM_ID=cur.TR_ID
...
INSERT INTO @TemptaskDetailsQUOTA_Updated_@mPIC 
	...
	cur.[ACTUAL_OUTPUT] AS [ACTUAL_OUTPUT],cur.[QUOTA], (cur.[QUOTA]/9) * cur.[WORKED_HOURS] AS ACTUAL_QOUTA,cur.TR_UOM,cur.PCP_ID,cur.Task_ID,cur.PC_ProcessCode,cur.PCP_Project, CASE WHEN cur.MODIFIED_OUTPUT>0 THEN ((cur.MODIFIED_OUTPUT/cur.QUOTA) * @K) ELSE ((cur.ACTUAL_OUTPUT/cur.QUOTA) * @K) END  AS X1, CASE WHEN cur.MODIFIED_OUTPUT>0 THEN ((MODIFIED_WORKED_HOURS * 3600)) ELSE ((cur.WORKED_HOURS * 3600)) END  AS Y, ((CASE WHEN cur.MODIFIED_OUTPUT>0 THEN ((cur.MODIFIED_OUTPUT/cur.QUOTA) * @K) ELSE ((cur.ACTUAL_OUTPUT/cur.QUOTA) * @K) END)/(CASE WHEN cur.MODIFIED_OUTPUT>0 THEN ((MODIFIED_WORKED_HOURS * 3600)) ELSE ((cur.WORKED_HOURS * 3600)) END)) * 100 AS X3
