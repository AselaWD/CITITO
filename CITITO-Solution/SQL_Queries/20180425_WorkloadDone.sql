CREATE PROC Dboard_WorkLoad_DoneTitles @mPIC nvarchar(30) 
...
CREATE PROC Dboard_WorkLoad_DoneTitlesDetails @mPIC nvarchar(30), @mProject nvarchar(100), @mJobCode nvarchar(200), @mShipment nvarchar(1000)
...
CREATE PROC Dboard_WorkLoad_DoneTitlesDataSet @mPIC nvarchar(30) 
