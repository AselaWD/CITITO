CREATE PROC Dboard_WorkLoad_PendingTitles @mPIC nvarchar(30) 
...
CREATE PROC Dboard_WorkLoad_PendingTitlesDetails @mPIC nvarchar(30), @mProject nvarchar(100), @mJobCode nvarchar(200), @mShipment nvarchar(1000)
...
CREATE PROC Dboard_WorkLoad_PendingTitlesDataSet @mPIC nvarchar(30) 
