CREATE PROC Dboard_WorkLoad_HoldTitles @mPIC nvarchar(30) 
...
CREATE PROC Dboard_WorkLoad_HoldTitlesDetails @mPIC nvarchar(30), @mProject nvarchar(100), @mJobCode nvarchar(200), @mShipment nvarchar(1000)
...
CREATE PROC Dboard_WorkLoad_HoldTitlesDataSet @mPIC nvarchar(30) 
